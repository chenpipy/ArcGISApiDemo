...
module.exports = {
    entry: ['./demo3.6/图层标注.html', './demo3.5/绘制Graphic.html', './demo3.7/鼠标绘制graphic.html', './demo3.8/demo8图例.html', './demo4.1/空间查询.html'],    //entry是数组，那么数组中的js文件，会打包成一个js文件
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
             filename:'图层标注.html',  //如果是单文件入口，可以不加
